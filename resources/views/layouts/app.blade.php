...
<head>
    ...
    <script type="application/ld+json">@json(['@context'=>'https://schema.org','@type'=>'LegalService','name'=>config('lawoffice.office.name'),'description'=>config('lawoffice.office.description'),'address'=>['@type'=>'PostalAddress','addressLocality'=>'الإسكندرية','addressCountry'=>'EG']])</script>
